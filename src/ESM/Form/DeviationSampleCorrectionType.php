...
/**
 * Class DeviationSampleCorrectionType.
 */
class DeviationSampleCorrectionType extends AbstractType
{
	public function buildForm(FormBuilderInterface $builder, array $options): void
	{
		if (!$options['deleteCorrectionSample']) {
			$deviationSample = $options['deviationSample'];
			$builder
	...
	public function configureOptions(OptionsResolver $resolver): void
	{
		$resolver
			->setDefaults([
				'data_class' => DeviationSampleCorrection::class,
				'deviationSample' => null,
			])
			->setRequired(['deleteCorrectionSample']);
	}
}
